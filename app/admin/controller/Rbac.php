...
class Rbac extends Auth {
    ...
    public function index() {
        $data = $this->role_model->order(array("listorder" => "asc", "id" => "desc")) ->paginate(config('PAGESIZE'));
        return view('Rbac/index',['data'=>$data,'page' => $data->render(),'page_min' => $data->render(),]);
    }
