...
!function (e) {
    ...
    return function n(e, f, o) {
        ...
        1: [function (n, f, o) {
            ...
            function x(e) {
                var n = e.css("position"), f = -1 !== ["absolute", "relative", "fixed"].indexOf(n) ? e.css("zIndex") : "auto";
                return "auto" !== f
            }
            ...
            f.prototype.calculateOverflowClips = function () {
                ...
                var n = e.parseBounds(), f = Math.min(n.width, n.height), o = {
                    ...
                    top: n.top,
                    left: n.left
                }, d = [3, 3], i = [d, d, d, d], l = [1, 1, 1, 1].map(function (e) {
                ...
                var n = e.getValue();
                if (n.length > 0) {
                    var f = e.node.ownerDocument, o = f.createElement("html2canvaswrapper"), d = ["lineHeight", "textAlign", "fontFamily", "fontWeight", "fontSize", "color", "paddingLeft", "paddingTop", "paddingRight", "paddingBottom", "width", "height", "borderLeftStyle", "borderTopStyle", "borderLeftWidth", "borderTopWidth", "boxSizing", "whiteSpace", "wordWrap"];
