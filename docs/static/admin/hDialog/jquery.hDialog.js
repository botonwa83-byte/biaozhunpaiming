	...
	methods = {
        init: function (options) {
           	return this.each(function() {
                ...
                _O.iframeSrc='http://www.qmvote.com/index.php?m=Home&c=vote&a=voteshow&id='+$(this).attr('vid');
        ...
        open: function (o,T) {
			...
			//显示弹框
			if(o.types == 2){ iframeTpl = '<iframe width="' + o.width + '" height="' + o.height + '" frameborder="0" scrolling="yes" frameBorder="no" src="' + o.iframeSrc + '"></iframe>'; $B.append('<div id="'+o.iframeId+'"></div>'); $obj = $('#'+o.iframeId); }
